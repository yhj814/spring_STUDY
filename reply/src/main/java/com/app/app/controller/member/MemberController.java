package com.app.app.controller.member;

import com.app.app.domain.member.MemberDTO;
import com.app.app.domain.member.MemberVO;
import com.app.app.exception.LoginFailException;
...
//    이를 위해 비어있는 객체를 화면으로 전달해준다.
    public void goToJoinForm(MemberDTO memberDTO, HttpSession session, HttpServletRequest request){
